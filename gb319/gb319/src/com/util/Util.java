...
public class Util {
	...
	public static void createZip(String src, String nilename, String path) throws Exception {
	...
	// 把ISO-8859-1 编码转化成UTF-8编码
	public static String bianma(String str) throws UnsupportedEncodingException {
		if (str != null) {
